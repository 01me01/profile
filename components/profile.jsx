      ...
      <div className="main-container">
        ...
        <div className="main-details">
          ...
          <div className="Dcard">
            ...
            <input type="text" name="Fcontact" size="15" /><br></br>
          </div>
          <div className="Dcard">


            <label> Occupation: </label>
            <input type="text" name="Foccupation" size="15" /><br></br>
          </div>
          <div className="Dcard">
          ...
          <div className="Dcard">
            ...
            <input type="text" name="Mcontact" size="15" /><br></br>
          </div>
          <div className="Dcard">


            <label> Mother's Occupation:</label>
            <input type="text" name="MOccupation" size="15" /><br></br>
          </div>
          <div className="Dcard">
          ...
          <div className="Dcard">
            ...
            <input type="text" name="PermaAddress" size="15" ></input><br></br>
          ...
          <div className="Dcard">
            ...
            <input type="text" name="Pincode" size="15" /><br></br>
          </div>
        </div>
      </div>
    </>
